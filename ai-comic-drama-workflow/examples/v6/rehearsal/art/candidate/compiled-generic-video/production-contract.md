...
ART_RAIN_NIGHT / revision 1 / ArtIR 1

SC_RAIN_NIGHT 单镜文字美术候选；Canon 与 DirectorIR 只读。未绑定真实图片、未生成视频。
...
```json
{
  "checks": [
    {
      "blocking": true,
      "evidence_required": "本候选 source-integrity 与 module-receipt 证据。",
      "gate": "G0",
      "id": "C_INPUT",
      "method": "static",
      "owner": "art_planner",
    ...
    {
      "blocking": true,
      "evidence_required": "合同覆盖表及 V5/V6 handoff 映射。",
      "gate": "G2",
      "id": "C_MAP",
      "method": "static",
      "owner": "host_reviewer",
  ...
  "sources": [
    ...
    },
    {
      ...
      "uri": "/private/tmp/ai-video-v6-real-efKlQy/project/runtime/v6/candidates/TASK_0e0c8a4ca94c8ffdbb7e14ae/1/canon.json",
      "verification": "read"
    },
    {
      "claim": "固定双人中近景、世界坐标预演、手部交接与封口和背包开口可见性；导演时序与动作只读。",
      "id": "DIRECTOR",
      "kind": "director",
      "locator": "/scenes/0 /shots/0 /timeline/actions /contract",
      "uri": "/private/tmp/ai-video-v6-real-efKlQy/project/runtime/v6/candidates/TASK_b1e7ff7ce83d7a32bfa09935/3/director-ir.json",
      "verification": "read"
    },
    {
      "claim": "中性低干扰美术方案；不声明具体地点、年代、职业、关系、信件内容或已生成媒体。",
      "id": "ART_DESIGN",
      "kind": "design",
      "locator": "本 ArtIR 的色材、简化环境、服化与道具外观建议",
      "uri": "design://TASK_0560d46ecc764c68ee9a590e/scene-painter-v1",
