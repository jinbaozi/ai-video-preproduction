...
ART_RAIN_NIGHT / revision 2 / ArtIR 3
...
```json
{
  ...
  "sources": [
    ...
    {
      "claim": "当前冻结 DirectorIR v14 的单镜布局、手部交接、封口及包口可见约束；修正后的坐标表达与世界 X-right,Y-depth,Z-up 一致；动作时序与控制权以只读 /timeline/actions 为准。",
      "id": "DIRECTOR",
      "kind": "director",
      "locator": "/scenes/0 /shots/0 /timeline/actions /contract",
      "uri": "/private/tmp/ai-video-v6-real-efKlQy/project/runtime/v6/candidates/TASK_19a3cd14f25bf90e50215d4d/1/director-ir.json",
      "verification": "read"
    },
    {
      ...
      "id": "ART_DESIGN",
      "kind": "design",
      "locator": "本次 ArtIR 场景与资产中性可读设计；复核旧候选设计后重新绑定当前冻结 Director 与 Canon",
      "uri": "design://TASK_536f58cce58a7823bdf4a3f3/art-scope-revision-3",
