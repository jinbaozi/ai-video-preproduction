...
actions = [
    ...
    action('ACT_CONFIRM_SEAL', 4500, 7500, 'GROUP_CONFIRM', 'EVT_SEAL_CHECK', 'CHAR_YI', 'PROP_LETTER',
           ...
           [change('CHAR_YI','gaze','甲手中的信','同一封信的封口',5500),
...
ir={
    'schema_version':'1.2','project_id':'LETTER_DEMO','revision':1,'canon_ref':str(CANON),
    'sources':sources,
...
ir['timeline']['semantic_review']={
    'status':'PASS','reviewer':'/root/host_bridge/v6_06e72da81da7989f0b415f37 / current-agent source-bound review',
    ...
    'findings':[
        ...
        '关键状态样本覆盖双方握持、乙取得控制、验封完成和信入包；G3/G4 真实媒体检查仍 NOT_RUN。']}
...
stamp={'screenplay_sha256':handoff['content_sha256'],
       ...
       'reviewer':'/root/host_bridge/v6_06e72da81da7989f0b415f37 / current-agent screenplay mapping review',
