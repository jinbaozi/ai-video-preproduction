...
REL = 'runtime/v6/candidates/TASK_eb6702e9e268b2ba339b0fcf/1'
OUT = ROOT / REL
...
native = {'status': 'PASS', 'validator': MODREL + '/scripts/dg.py validate',
          ...
          'note': '原生静态校验及当前 Agent 语义复核，不代表真实媒体通过。'}
...
handoff_check = {'status': 'PASS', 'canon_source_requirements': len(canon_mappings),
                 ...
                 'semantic_finding': '雨夜未指定地点；同一信件 ID 贯穿；先交接、后验封、再入包；无新增对白。',
                 'media': 'NOT_RUN'}
...
checks = [
    ...
    {'id': 'native_validator', 'status': 'PASS', 'finding': 'DirectorIR 1.2 原生静态校验无错误，编剧绑定为 REVIEW_ATTESTED；媒体未执行。',
     'evidence': [REL + '/evidence/native-validator.json']},
...
candidate = {'schema': 'candidate-result/6.0', 'task_id': role_result['task_id'], 'batch': 1,
    'agent_id': '/root/host_bridge/full_rehearsal/v6_83a899880d2e84fbf7f0a5a4',
    'input_digest': '2b00777d35fa703103ba03c9c7ffc2546b117bd3fcf93e59caab0810ae355e79',
