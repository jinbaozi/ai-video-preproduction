...
OUT = ROOT / 'runtime/v6/candidates/TASK_eb6702e9e268b2ba339b0fcf/1'
...
ir = {'schema_version': '1.2', 'project_id': 'LETTER_FULL_DEMO', 'revision': 1,
    ...
    'sources': [
        ...
        {'id': design, 'kind': 'design', 'uri': 'design://LETTER_FULL_DEMO/director-v1',
...
ir['timeline']['semantic_review'] = {
    'status': 'PASS', 'reviewer': 'current-agent / TASK_eb6702e9e268b2ba339b0fcf / batch 1',
    'input_sha256': None,
    'findings': [
        '雨夜、同一封未拆信与交接→验封→入包顺序对照冻结 Canon 和 ScriptIR；没有添加对白、信件内容、人物身份或具体地点。',
        '三镜均为导演视听设计，封口在验封镜可辨；结尾信已在包内，先验封后入包。',
...
save('screenplay-map.json', {'schema': 'screenplay-director-map/1.0',
    ...
    'reviewer': 'current-agent / TASK_eb6702e9e268b2ba339b0fcf / batch 1',
